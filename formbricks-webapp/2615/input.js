...
__webpack_require__.d(__webpack_exports__, {
  ProjectConfigNavigation: () => (/* binding */ ProjectConfigNavigation)
});
 ...
 */ 
const Brush = (0,createLucideIcon/* default */.A)("Brush", [
    [
        "path",
        {
 ...
 * See the LICENSE file in the root directory of this source tree.
 */ 
const ListChecks = (0,createLucideIcon/* default */.A)("ListChecks", [
    [
        "path",
        {
            d: "m3 17 2 2 4-4",
...
;// ./modules/projects/settings/components/project-config-navigation.tsx
/* __next_internal_client_entry_do_not_use__ ProjectConfigNavigation auto */ 




const ProjectConfigNavigation = ({ activeId, environmentId, isMultiLanguageAllowed, loading, canDoRoleManagement })=>{
    ...
    let navigation = [
        {
            ...
            icon: /*#__PURE__*/ (0,react_jsx_runtime.jsx)(users/* default */.A, {
                className: "h-5 w-5"
            }),
        ...
        },
        {
            ...
            icon: /*#__PURE__*/ (0,react_jsx_runtime.jsx)(Brush, {
                className: "h-5 w-5"
            }),
        ...
        },
        {
            ...
            icon: /*#__PURE__*/ (0,react_jsx_runtime.jsx)(languages/* default */.A, {
                className: "h-5 w-5"
            }),
        ...
        },
        {
            ...
            icon: /*#__PURE__*/ (0,react_jsx_runtime.jsx)(key/* default */.A, {
                className: "h-5 w-5"
            }),
        ...
        },
        {
            ...
            icon: /*#__PURE__*/ (0,react_jsx_runtime.jsx)(ListChecks, {
                className: "h-5 w-5"
            }),
 ...
 * See the LICENSE file in the root directory of this source tree.
 */ 
const Tag = (0,_createLucideIcon_js__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .A)("Tag", [
    [
        "path",
        {
...
;// ./modules/projects/settings/layout.tsx
...
const ProjectSettingsLayout = async (props)=>{
    ...
    const { isBilling } = (0,utils/* getAccessFlags */.c)(currentUserMembership?.role);
    if (isBilling) {
        return (0,navigation_react_server.redirect)(`/environments/${params.environmentId}/settings/billing`);
    }
...
;// ./app/(app)/environments/[environmentId]/project/layout.tsx


/* harmony default export */ const layout = (ProjectSettingsLayout);
...
"use strict";
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   ProjectConfigNavigation: () => (/* binding */ ProjectConfigNavigation)
/* harmony export */ });
...
const ProjectConfigNavigation = (0,react_server_dom_webpack_server_edge__WEBPACK_IMPORTED_MODULE_0__.registerClientReference)(
function() { throw new Error("Attempted to call ProjectConfigNavigation() from the server but ProjectConfigNavigation is on the client. It's not possible to invoke a client function from the server, it can only be rendered as a Component or passed to props of a Client Component."); },
"/Users/kdy1/projects/formbricks/apps/web/modules/projects/settings/components/project-config-navigation.tsx",
