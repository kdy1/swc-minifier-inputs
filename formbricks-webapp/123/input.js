...
// UNUSED EXPORTS: AutoScrollActivator, DragOverlay, MeasuringFrequency, MeasuringStrategy, TraversalOrder, applyModifiers, defaultAnnouncements, defaultCoordinates, defaultDropAnimation, defaultDropAnimationSideEffects, defaultKeyboardCoordinateGetter, defaultScreenReaderInstructions, getFirstCollision, getScrollableAncestors, pointerWithin, rectIntersection, useDndMonitor
...
function Accessibility(_ref) {
  ...
  const markup = react_default().createElement((react_default()).Fragment, null, react_default().createElement(HiddenText, {
    id: hiddenTextDescribedById,
    value: screenReaderInstructions.draggable
  }), react_default().createElement(LiveRegion, {
    id: liveRegionId,
...
const DndContext = /*#__PURE__*/(0,react.memo)(function DndContext(_ref) {
  ...
  return react_default().createElement(DndMonitorContext.Provider, {
    value: registerMonitorListener
  }, react_default().createElement(InternalContext.Provider, {
    value: internalContext
  }, react_default().createElement(PublicContext.Provider, {
    value: publicContext
  }, react_default().createElement(ActiveDraggableContext.Provider, {
    value: transform
  }, children)), react_default().createElement(RestoreFocus, {
    disabled: (accessibility == null ? void 0 : accessibility.restoreFocus) === false
  })), react_default().createElement(Accessibility, { ...accessibility,
...
/* harmony export */   m$: () => (/* binding */ horizontalListSortingStrategy)
/* harmony export */ });
...
/* harmony import */ var _dnd_kit_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(288187);
/* harmony import */ var _dnd_kit_utilities__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(63564);
 ...
 * See the LICENSE file in the root directory of this source tree.
 */ 
const Pencil = (0,_createLucideIcon_js__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .A)("Pencil", [
    [
        "path",
        {
