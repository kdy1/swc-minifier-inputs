...
// NAMESPACE OBJECT: ./app/api/v1/integrations/airtable/callback/route.ts
...
;// ./app/api/v1/integrations/airtable/callback/route.ts
...
const getEmail = async (token)=>{
    ...
    return lib/* string */.Yj().parse(res_?.email);
};
const GET = async (req)=>{
    const url = req.url;
    ...
    if (!environmentId) {
        return response/* responses */.n.badRequestResponse("Invalid environmentId");
    }
    if (!session) {
        return response/* responses */.n.notAuthenticatedResponse();
    }
    if (code && typeof code !== "string") {
        return response/* responses */.n.badRequestResponse("`code` must be a string");
    }
    ...
    const client_id = constants/* AIRTABLE_CLIENT_ID */.JB;
    const redirect_uri = constants/* WEBAPP_URL */.YW + "/api/v1/integrations/airtable/callback";
    const code_verifier = Buffer.from(environmentId + session.user.id + environmentId).toString("base64");
    if (!client_id) return response/* responses */.n.internalServerErrorResponse("Airtable client id is missing");
    if (!redirect_uri) return response/* responses */.n.internalServerErrorResponse("Airtable redirect url is missing");
    const formData = {
    ...
    try {
        const key = await (0,service/* fetchAirtableAuthToken */.Wd)(formData);
        if (!key) {
            return response/* responses */.n.notFoundResponse("airtable auth token", key);
        }
        ...
        await (0,integration_service/* createOrUpdateIntegration */.d6)(environmentId, airtableIntegrationInput);
        return Response.redirect(`${constants/* WEBAPP_URL */.YW}/environments/${environmentId}/integrations/airtable`);
    } catch (error) {
        console.error(error);
        response/* responses */.n.internalServerErrorResponse(error);
    }
    response/* responses */.n.badRequestResponse("unknown error occurred");
};

;// ../../node_modules/next/dist/build/webpack/loaders/next-app-loader/index.js?page=%2Fapi%2Fv1%2Fintegrations%2Fairtable%2Fcallback%2Froute&name=app%2Fapi%2Fv1%2Fintegrations%2Fairtable%2Fcallback%2Froute&pagePath=private-next-app-dir%2Fapi%2Fv1%2Fintegrations%2Fairtable%2Fcallback%2Froute.ts&appDir=%2FUsers%2Fkdy1%2Fprojects%2Fformbricks%2Fapps%2Fweb%2Fapp&appPaths=%2Fapi%2Fv1%2Fintegrations%2Fairtable%2Fcallback%2Froute&pageExtensions=tsx&pageExtensions=ts&pageExtensions=jsx&pageExtensions=js&basePath=&assetPrefix=&nextConfigOutput=standalone&nextConfigExperimentalUseEarlyImport=&preferredRegion=&middlewareConfig=e30%3D!
...
const routeModule = new module_compiled.AppRouteRouteModule({
    definition: {
        ...
        page: "/api/v1/integrations/airtable/callback/route",
        pathname: "/api/v1/integrations/airtable/callback",
        filename: "route",
        bundlePath: "app/api/v1/integrations/airtable/callback/route"
    },
    resolvedPagePath: "/Users/kdy1/projects/formbricks/apps/web/app/api/v1/integrations/airtable/callback/route.ts",
    nextConfigOutput,
...
var __webpack_exports__ = __webpack_require__.X(0, [8079,3073,7863,5069,255,9759,3687], () => (__webpack_exec__(359685)));
