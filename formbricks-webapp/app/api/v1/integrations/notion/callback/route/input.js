...
// NAMESPACE OBJECT: ./app/api/v1/integrations/notion/callback/route.ts
...
;// ./app/api/v1/integrations/notion/callback/route.ts
...
const GET = async (req)=>{
    ...
    if (code) {
        ...
        const encryptedAccessToken = (0,lib_crypto/* symmetricEncrypt */.vX)(tokenData.access_token, constants/* ENCRYPTION_KEY */.o7);
        ...
        const result = await (0,service/* createOrUpdateIntegration */.d6)(environmentId, notionIntegration);
        if (result) {
            return Response.redirect(`${constants/* WEBAPP_URL */.YW}/environments/${environmentId}/integrations/notion`);
        }
    } else if (error) {
        return Response.redirect(`${constants/* WEBAPP_URL */.YW}/environments/${environmentId}/integrations/notion?error=${error}`);
    }
};

;// ../../node_modules/next/dist/build/webpack/loaders/next-app-loader/index.js?page=%2Fapi%2Fv1%2Fintegrations%2Fnotion%2Fcallback%2Froute&name=app%2Fapi%2Fv1%2Fintegrations%2Fnotion%2Fcallback%2Froute&pagePath=private-next-app-dir%2Fapi%2Fv1%2Fintegrations%2Fnotion%2Fcallback%2Froute.ts&appDir=%2FUsers%2Fkdy1%2Fprojects%2Fformbricks%2Fapps%2Fweb%2Fapp&appPaths=%2Fapi%2Fv1%2Fintegrations%2Fnotion%2Fcallback%2Froute&pageExtensions=tsx&pageExtensions=ts&pageExtensions=jsx&pageExtensions=js&basePath=&assetPrefix=&nextConfigOutput=standalone&nextConfigExperimentalUseEarlyImport=&preferredRegion=&middlewareConfig=e30%3D!
...
const routeModule = new module_compiled.AppRouteRouteModule({
    definition: {
        ...
        page: "/api/v1/integrations/notion/callback/route",
        pathname: "/api/v1/integrations/notion/callback",
        filename: "route",
        bundlePath: "app/api/v1/integrations/notion/callback/route"
    },
    resolvedPagePath: "/Users/kdy1/projects/formbricks/apps/web/app/api/v1/integrations/notion/callback/route.ts",
    nextConfigOutput,
...
var __webpack_exports__ = __webpack_require__.X(0, [8079,3073,7863,5069], () => (__webpack_exec__(421466)));
