...
// NAMESPACE OBJECT: ./app/api/v1/integrations/slack/route.ts
...
;// ./app/api/v1/integrations/slack/route.ts
...
const GET = async (req)=>{
    ...
    if (!constants/* SLACK_CLIENT_ID */.jH) return response/* responses */.n.internalServerErrorResponse("Slack client id is missing");
    if (!constants/* SLACK_CLIENT_SECRET */.K8) return response/* responses */.n.internalServerErrorResponse("Slack client secret is missing");
    if (!constants/* SLACK_AUTH_URL */.st) return response/* responses */.n.internalServerErrorResponse("Slack auth url is missing");
    return response/* responses */.n.successResponse({
        authUrl: `${constants/* SLACK_AUTH_URL */.st}&state=${environmentId}`
    });
};

;// ../../node_modules/next/dist/build/webpack/loaders/next-app-loader/index.js?page=%2Fapi%2Fv1%2Fintegrations%2Fslack%2Froute&name=app%2Fapi%2Fv1%2Fintegrations%2Fslack%2Froute&pagePath=private-next-app-dir%2Fapi%2Fv1%2Fintegrations%2Fslack%2Froute.ts&appDir=%2FUsers%2Fkdy1%2Fprojects%2Fformbricks%2Fapps%2Fweb%2Fapp&appPaths=%2Fapi%2Fv1%2Fintegrations%2Fslack%2Froute&pageExtensions=tsx&pageExtensions=ts&pageExtensions=jsx&pageExtensions=js&basePath=&assetPrefix=&nextConfigOutput=standalone&nextConfigExperimentalUseEarlyImport=&preferredRegion=&middlewareConfig=e30%3D!
...
const routeModule = new module_compiled.AppRouteRouteModule({
    definition: {
        ...
        page: "/api/v1/integrations/slack/route",
        pathname: "/api/v1/integrations/slack",
        filename: "route",
        bundlePath: "app/api/v1/integrations/slack/route"
    },
    resolvedPagePath: "/Users/kdy1/projects/formbricks/apps/web/app/api/v1/integrations/slack/route.ts",
    nextConfigOutput,
...
var __webpack_exports__ = __webpack_require__.X(0, [8079,3073,7863,5069,255,9759,3687], () => (__webpack_exec__(831728)));
