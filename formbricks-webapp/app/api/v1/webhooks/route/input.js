...
// NAMESPACE OBJECT: ./app/api/v1/webhooks/route.ts
...
;// ./app/api/v1/webhooks/types/webhooks.ts

const ZWebhookInput = webhooks/* ZWebhook */.Q.partial({
    name: true,
    source: true,
    surveyIds: true
}).pick({
...
;// ./app/api/v1/webhooks/lib/webhook.ts
...
const getWebhooks = (environmentId, page)=>(0,cache/* cache */.P)(async ()=>{
        (0,validate/* validateInputs */.C)([
            environmentId,
            common/* ZId */.i4
        ], [
...
const GET = async ()=>{
    ...
    try {
        ...
        return response/* responses */.n.internalServerErrorResponse(error.message);
    }
};
...
;// ../../node_modules/next/dist/build/webpack/loaders/next-app-loader/index.js?page=%2Fapi%2Fv1%2Fwebhooks%2Froute&name=app%2Fapi%2Fv1%2Fwebhooks%2Froute&pagePath=private-next-app-dir%2Fapi%2Fv1%2Fwebhooks%2Froute.ts&appDir=%2FUsers%2Fkdy1%2Fprojects%2Fformbricks%2Fapps%2Fweb%2Fapp&appPaths=%2Fapi%2Fv1%2Fwebhooks%2Froute&pageExtensions=tsx&pageExtensions=ts&pageExtensions=jsx&pageExtensions=js&basePath=&assetPrefix=&nextConfigOutput=standalone&nextConfigExperimentalUseEarlyImport=&preferredRegion=&middlewareConfig=e30%3D!
...
const routeModule = new module_compiled.AppRouteRouteModule({
    definition: {
        ...
        page: "/api/v1/webhooks/route",
        pathname: "/api/v1/webhooks",
        filename: "route",
        bundlePath: "app/api/v1/webhooks/route"
    },
    resolvedPagePath: "/Users/kdy1/projects/formbricks/apps/web/app/api/v1/webhooks/route.ts",
    nextConfigOutput,
...
var __webpack_exports__ = __webpack_require__.X(0, [8079,3073,7863,5069,255], () => (__webpack_exec__(42803)));
