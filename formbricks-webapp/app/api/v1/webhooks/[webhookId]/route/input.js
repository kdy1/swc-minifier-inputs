...
// NAMESPACE OBJECT: ./app/api/v1/webhooks/[webhookId]/route.ts
...
// EXTERNAL MODULE: ./app/api/v1/lib/api-key.ts
var api_key = __webpack_require__(993240);
...
;// ./app/api/v1/webhooks/[webhookId]/lib/webhook.ts
...
const getWebhook = async (id)=>(0,cache/* cache */.P)(async ()=>{
        (0,validate/* validateInputs */.C)([
            id,
            common/* ZId */.i4
        ]);
        try {
            const webhook = await src/* prisma */.z.webhook.findUnique({
                where: {
                    id
                }
            });
        ...
        tags: [
            webhook/* webhookCache */.Q.tag.byId(id)
        ]
    })();
...
const GET = async (_, props)=>{
    ...
    const environmentId = await (0,api_key/* getEnvironmentIdFromApiKey */.m)(apiKey);
    if (!environmentId) {
        return response/* responses */.n.notAuthenticatedResponse();
    }
    ...
    if (!webhook) {
        return response/* responses */.n.notFoundResponse("Webhook", params.webhookId);
    }
    if (webhook.environmentId !== environmentId) {
        return response/* responses */.n.unauthorizedResponse();
    }
    return response/* responses */.n.successResponse(webhook);
};
...
;// ../../node_modules/next/dist/build/webpack/loaders/next-app-loader/index.js?page=%2Fapi%2Fv1%2Fwebhooks%2F%5BwebhookId%5D%2Froute&name=app%2Fapi%2Fv1%2Fwebhooks%2F%5BwebhookId%5D%2Froute&pagePath=private-next-app-dir%2Fapi%2Fv1%2Fwebhooks%2F%5BwebhookId%5D%2Froute.ts&appDir=%2FUsers%2Fkdy1%2Fprojects%2Fformbricks%2Fapps%2Fweb%2Fapp&appPaths=%2Fapi%2Fv1%2Fwebhooks%2F%5BwebhookId%5D%2Froute&pageExtensions=tsx&pageExtensions=ts&pageExtensions=jsx&pageExtensions=js&basePath=&assetPrefix=&nextConfigOutput=standalone&nextConfigExperimentalUseEarlyImport=&preferredRegion=&middlewareConfig=e30%3D!
...
const routeModule = new module_compiled.AppRouteRouteModule({
    definition: {
        ...
        filename: "route",
        bundlePath: "app/api/v1/webhooks/[webhookId]/route"
    },
    resolvedPagePath: "/Users/kdy1/projects/formbricks/apps/web/app/api/v1/webhooks/[webhookId]/route.ts",
    nextConfigOutput,
...
var __webpack_exports__ = __webpack_require__.X(0, [8079,3073,7863,5069,255], () => (__webpack_exec__(331725)));
