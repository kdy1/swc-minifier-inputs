...
// NAMESPACE OBJECT: ./app/api/v1/management/contacts/[contactId]/route.ts
var _contactId_route_namespaceObject = {};
__webpack_require__.r(_contactId_route_namespaceObject);
__webpack_require__.d(_contactId_route_namespaceObject, {
  DELETE: () => (DELETE),
  GET: () => (GET)
});
...
;// ./modules/ee/contacts/api/management/contacts/[contactId]/lib/contact.ts
...
const deleteContact = async (contactId)=>{
    ...
    try {
        const deletedContact = await src/* prisma */.z.contact.delete({
            where: {
                id: contactId
            },
            select: {
...
;// ./modules/ee/contacts/api/management/contacts/[contactId]/route.ts
...
const fetchAndAuthorizeContact = async (authentication, contactId)=>{
    const contact = await getContact(contactId);
    if (!contact) {
        return null;
    }
    if (contact.environmentId !== authentication.environmentId) {
        throw new errors/* AuthorizationError */.yi("Unauthorized");
    }
    return contact;
};
const GET = async (request, { params: paramsPromise })=>{
    try {
        ...
        if (contact) {
            return response/* responses */.n.successResponse(contact);
        }
        return response/* responses */.n.notFoundResponse("Contact", params.contactId);
    } catch (error) {
...
;// ./app/api/v1/management/contacts/[contactId]/route.ts



;// ../../node_modules/next/dist/build/webpack/loaders/next-app-loader/index.js?page=%2Fapi%2Fv1%2Fmanagement%2Fcontacts%2F%5BcontactId%5D%2Froute&name=app%2Fapi%2Fv1%2Fmanagement%2Fcontacts%2F%5BcontactId%5D%2Froute&pagePath=private-next-app-dir%2Fapi%2Fv1%2Fmanagement%2Fcontacts%2F%5BcontactId%5D%2Froute.ts&appDir=%2FUsers%2Fkdy1%2Fprojects%2Fformbricks%2Fapps%2Fweb%2Fapp&appPaths=%2Fapi%2Fv1%2Fmanagement%2Fcontacts%2F%5BcontactId%5D%2Froute&pageExtensions=tsx&pageExtensions=ts&pageExtensions=jsx&pageExtensions=js&basePath=&assetPrefix=&nextConfigOutput=standalone&nextConfigExperimentalUseEarlyImport=&preferredRegion=&middlewareConfig=e30%3D!
...
const routeModule = new module_compiled.AppRouteRouteModule({
    definition: {
        ...
        page: "/api/v1/management/contacts/[contactId]/route",
        pathname: "/api/v1/management/contacts/[contactId]",
        filename: "route",
        bundlePath: "app/api/v1/management/contacts/[contactId]/route"
    },
    resolvedPagePath: "/Users/kdy1/projects/formbricks/apps/web/app/api/v1/management/contacts/[contactId]/route.ts",
    nextConfigOutput,
    userland: _contactId_route_namespaceObject
});
...
var __webpack_exports__ = __webpack_require__.X(0, [8079,3073,7863,5069,5570,1238,9069,7762], () => (__webpack_exec__(607925)));
