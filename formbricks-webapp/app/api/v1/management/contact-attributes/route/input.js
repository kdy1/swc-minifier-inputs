...
// NAMESPACE OBJECT: ./app/api/v1/management/contact-attributes/route.ts
var contact_attributes_route_namespaceObject = {};
__webpack_require__.r(contact_attributes_route_namespaceObject);
__webpack_require__.d(contact_attributes_route_namespaceObject, {
  GET: () => (GET)
});
...
;// ./modules/ee/contacts/api/management/contact-attributes/lib/contact-attributes.ts
...
const getContactAttributes = (0,react.cache)((environmentId)=>(0,cache/* cache */.P)(async ()=>{
        try {
            const contactAttributeKeys = await src/* prisma */.z.contactAttribute.findMany({
                where: {
                    attributeKey: {
                        environmentId
                    }
        ...
        tags: [
            contact_attribute/* contactAttributeCache */.r.tag.byEnvironmentId(environmentId)
        ]
    })());

;// ./modules/ee/contacts/api/management/contact-attributes/route.ts
...
const GET = async (request)=>{
    try {
        ...
        return response/* responses */.n.successResponse(contactAttributes);
    } catch (error) {
...
;// ./app/api/v1/management/contact-attributes/route.ts



;// ../../node_modules/next/dist/build/webpack/loaders/next-app-loader/index.js?page=%2Fapi%2Fv1%2Fmanagement%2Fcontact-attributes%2Froute&name=app%2Fapi%2Fv1%2Fmanagement%2Fcontact-attributes%2Froute&pagePath=private-next-app-dir%2Fapi%2Fv1%2Fmanagement%2Fcontact-attributes%2Froute.ts&appDir=%2FUsers%2Fkdy1%2Fprojects%2Fformbricks%2Fapps%2Fweb%2Fapp&appPaths=%2Fapi%2Fv1%2Fmanagement%2Fcontact-attributes%2Froute&pageExtensions=tsx&pageExtensions=ts&pageExtensions=jsx&pageExtensions=js&basePath=&assetPrefix=&nextConfigOutput=standalone&nextConfigExperimentalUseEarlyImport=&preferredRegion=&middlewareConfig=e30%3D!
...
const routeModule = new module_compiled.AppRouteRouteModule({
    definition: {
        ...
        page: "/api/v1/management/contact-attributes/route",
        pathname: "/api/v1/management/contact-attributes",
        filename: "route",
        bundlePath: "app/api/v1/management/contact-attributes/route"
    },
    resolvedPagePath: "/Users/kdy1/projects/formbricks/apps/web/app/api/v1/management/contact-attributes/route.ts",
    nextConfigOutput,
    userland: contact_attributes_route_namespaceObject
});
...
var __webpack_exports__ = __webpack_require__.X(0, [8079,3073,7863,5069,5570,1238,9069,7762], () => (__webpack_exec__(818849)));
