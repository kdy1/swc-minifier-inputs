...
// NAMESPACE OBJECT: ./app/api/v1/management/surveys/[surveyId]/route.ts
...
;// ./app/api/v1/management/surveys/[surveyId]/route.ts
...
const fetchAndAuthorizeSurvey = async (authentication, surveyId)=>{
...
const DELETE = async (request, props)=>{
    ...
    try {
        ...
        const deletedSurvey = await (0,survey_service/* deleteSurvey */.MT)(params.surveyId);
        return response/* responses */.n.successResponse(deletedSurvey);
    } catch (error) {
        return (0,auth/* handleErrorResponse */.K)(error);
    }
};
const PUT = async (request, props)=>{
    ...
    try {
        ...
        const inputValidation = types/* ZSurveyUpdateInput */.Ue.safeParse({
            ...survey,
            ...surveyUpdate
        });
        ...
        if (surveyUpdate.followUps && surveyUpdate.followUps.length) {
            ...
            if (!isSurveyFollowUpsEnabled) {
                return response/* responses */.n.forbiddenResponse("Survey follow ups are not enabled for this organization");
            }
        }
        ...
        return response/* responses */.n.successResponse(await (0,survey_service/* updateSurvey */.cU)({
...
;// ../../node_modules/next/dist/build/webpack/loaders/next-app-loader/index.js?page=%2Fapi%2Fv1%2Fmanagement%2Fsurveys%2F%5BsurveyId%5D%2Froute&name=app%2Fapi%2Fv1%2Fmanagement%2Fsurveys%2F%5BsurveyId%5D%2Froute&pagePath=private-next-app-dir%2Fapi%2Fv1%2Fmanagement%2Fsurveys%2F%5BsurveyId%5D%2Froute.ts&appDir=%2FUsers%2Fkdy1%2Fprojects%2Fformbricks%2Fapps%2Fweb%2Fapp&appPaths=%2Fapi%2Fv1%2Fmanagement%2Fsurveys%2F%5BsurveyId%5D%2Froute&pageExtensions=tsx&pageExtensions=ts&pageExtensions=jsx&pageExtensions=js&basePath=&assetPrefix=&nextConfigOutput=standalone&nextConfigExperimentalUseEarlyImport=&preferredRegion=&middlewareConfig=e30%3D!
...
const routeModule = new module_compiled.AppRouteRouteModule({
    definition: {
        ...
        page: "/api/v1/management/surveys/[surveyId]/route",
        pathname: "/api/v1/management/surveys/[surveyId]",
        filename: "route",
        bundlePath: "app/api/v1/management/surveys/[surveyId]/route"
    },
    resolvedPagePath: "/Users/kdy1/projects/formbricks/apps/web/app/api/v1/management/surveys/[surveyId]/route.ts",
    nextConfigOutput,
...
var __webpack_exports__ = __webpack_require__.X(0, [8079,3073,7863,5069,6626,5570,1238,9069,7762,8728,9398,881,9358,3687,5863,7043], () => (__webpack_exec__(736920)));
