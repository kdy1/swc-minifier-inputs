...
// NAMESPACE OBJECT: ./app/api/v1/management/storage/route.ts
...
;// ./app/api/v1/management/storage/lib/getSignedUrl.ts


const getSignedUrlForPublicFile = async (fileName, environmentId, fileType)=>{
    const accessType = "public"; // public files are accessible by anyone
    // if s3 is not configured, we'll upload to a local folder named uploads
    try {
        const signedUrlResponse = await (0,service/* getUploadSignedUrl */.H2)(fileName, environmentId, fileType, accessType);
...
;// ./app/api/v1/management/storage/route.ts
...
const POST = async (req)=>{
    ...
    if (!fileType) {
        return response/* responses */.n.badRequestResponse("fileType is required");
    }
    if (!environmentId) {
    ...
    if (allowedFileExtensions?.length) {
        ...
        if (!fileExtension || !allowedFileExtensions.includes(fileExtension)) {
            return response/* responses */.n.badRequestResponse(`File extension is not allowed, allowed extensions are: ${allowedFileExtensions.join(", ")}`);
        }
    }
    ...
    const isUserAuthorized = await (0,auth/* hasUserEnvironmentAccess */.n)(session.user.id, environmentId);
    if (!isUserAuthorized) {
...
;// ../../node_modules/next/dist/build/webpack/loaders/next-app-loader/index.js?page=%2Fapi%2Fv1%2Fmanagement%2Fstorage%2Froute&name=app%2Fapi%2Fv1%2Fmanagement%2Fstorage%2Froute&pagePath=private-next-app-dir%2Fapi%2Fv1%2Fmanagement%2Fstorage%2Froute.ts&appDir=%2FUsers%2Fkdy1%2Fprojects%2Fformbricks%2Fapps%2Fweb%2Fapp&appPaths=%2Fapi%2Fv1%2Fmanagement%2Fstorage%2Froute&pageExtensions=tsx&pageExtensions=ts&pageExtensions=jsx&pageExtensions=js&basePath=&assetPrefix=&nextConfigOutput=standalone&nextConfigExperimentalUseEarlyImport=&preferredRegion=&middlewareConfig=e30%3D!
...
const routeModule = new module_compiled.AppRouteRouteModule({
    definition: {
        ...
        page: "/api/v1/management/storage/route",
        pathname: "/api/v1/management/storage",
        filename: "route",
        bundlePath: "app/api/v1/management/storage/route"
    },
    resolvedPagePath: "/Users/kdy1/projects/formbricks/apps/web/app/api/v1/management/storage/route.ts",
    nextConfigOutput,
...
var __webpack_exports__ = __webpack_require__.X(0, [8079,3073,7863,5069,255,9759,8728,3687], () => (__webpack_exec__(83373)));
