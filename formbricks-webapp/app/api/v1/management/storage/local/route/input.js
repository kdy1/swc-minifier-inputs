...
// NAMESPACE OBJECT: ./app/api/v1/management/storage/local/route.ts
...
;// ./app/api/v1/management/storage/local/route.ts
...
const POST = async (req)=>{
    ...
    try {
        ...
        await (0,service/* putFileToLocalStorage */.BY)(fileName, fileBuffer, accessType, environmentId, constants/* UPLOADS_DIR */.xG);
...
const routeModule = new module_compiled.AppRouteRouteModule({
    definition: {
        ...
        page: "/api/v1/management/storage/local/route",
        pathname: "/api/v1/management/storage/local",
        filename: "route",
        bundlePath: "app/api/v1/management/storage/local/route"
    },
    resolvedPagePath: "/Users/kdy1/projects/formbricks/apps/web/app/api/v1/management/storage/local/route.ts",
    nextConfigOutput,
...
var __webpack_exports__ = __webpack_require__.X(0, [8079,3073,7863,5069,255,9759,8728,3687], () => (__webpack_exec__(916324)));
