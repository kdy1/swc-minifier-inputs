...
// NAMESPACE OBJECT: ./app/api/v1/client/[environmentId]/user/route.ts
var user_route_namespaceObject = {};
__webpack_require__.r(user_route_namespaceObject);
__webpack_require__.d(user_route_namespaceObject, {
  OPTIONS: () => (OPTIONS),
  POST: () => (POST)
});
...
var lib_attributes = __webpack_require__(478845);
...
;// ./modules/ee/contacts/api/client/[environmentId]/user/lib/contact.ts
...
const getContactByUserIdWithAttributes = (0,react.cache)((environmentId, userId)=>(0,cache/* cache */.P)(async ()=>{
...
;// ./modules/ee/contacts/api/client/[environmentId]/user/lib/segments.ts
...
const getPersonSegmentIds = (environmentId, contactId, contactUserId, attributes, deviceType)=>(0,cache/* cache */.P)(async ()=>{
...
;// ./modules/ee/contacts/api/client/[environmentId]/user/lib/user-state.ts
 ...
 */ const getUserState = async ({ environmentId, userId, contactId, device, attributes })=>(0,cache/* cache */.P)(async ()=>{
        ...
        const contactDisplays = await src/* prisma */.z.display.findMany({
            where: {
                contactId
            },
            select: {
        ...
        const userState = {
            userId,
            segments,
            displays: contactDisplays?.map((display)=>({
                    surveyId: display.surveyId,
                    createdAt: display.createdAt
                })) ?? [],
            responses: contactResponses?.map((response)=>response.surveyId) ?? [],
            lastDisplayAt: contactDisplays.length > 0 ? contactDisplays.sort((a, b)=>b.createdAt.getTime() - a.createdAt.getTime())[0].createdAt : null
        };
        return userState;
    }, [
...
;// ./modules/ee/contacts/api/client/[environmentId]/user/lib/update-user.ts
...
const updateUser = async (environmentId, userId, device, attributes)=>{
    ...
    let contactAttributes = contact.attributes.reduce((acc, ctx)=>{
    ...
    if (attributes && Object.keys(attributes).length > 0) {
        ...
        const oldAttributes = contact.attributes.reduce((acc, ctx)=>{
            acc[ctx.attributeKey.key] = ctx.value;
            return acc;
        }, {});
        ...
        if (shouldUpdate) {
            const { success, messages: updateAttrMessages } = await (0,lib_attributes/* updateAttributes */.F)(contact.id, userId, environmentId, attributes);
...
;// ./modules/ee/contacts/api/client/[environmentId]/user/route.ts
...
const POST = async (request, props)=>{
    const params = await props.params;
    try {
        const { environmentId } = params;
        const jsonInput = await request.json();
        // Validate input
        const syncInputValidation = js/* ZJsUserIdentifyInput */.$U.pick({
            environmentId: true
        }).safeParse({
            environmentId
        });
        ...
        const parsedInput = js/* ZJsUserUpdateInput */.e_.safeParse(jsonInput);
        ...
        let attributeUpdatesToSend = null;
        if (attributes) {
        ...
        try {
            const { state: userState, messages } = await updateUser(environmentId, userId, deviceType, attributeUpdatesToSend ?? undefined);
            let responseJson = {
                state: userState
            };
            ...
            return response/* responses */.n.successResponse(responseJson, true);
        } catch (err) {
...
;// ./app/api/v1/client/[environmentId]/user/route.ts



;// ../../node_modules/next/dist/build/webpack/loaders/next-app-loader/index.js?page=%2Fapi%2Fv1%2Fclient%2F%5BenvironmentId%5D%2Fuser%2Froute&name=app%2Fapi%2Fv1%2Fclient%2F%5BenvironmentId%5D%2Fuser%2Froute&pagePath=private-next-app-dir%2Fapi%2Fv1%2Fclient%2F%5BenvironmentId%5D%2Fuser%2Froute.ts&appDir=%2FUsers%2Fkdy1%2Fprojects%2Fformbricks%2Fapps%2Fweb%2Fapp&appPaths=%2Fapi%2Fv1%2Fclient%2F%5BenvironmentId%5D%2Fuser%2Froute&pageExtensions=tsx&pageExtensions=ts&pageExtensions=jsx&pageExtensions=js&basePath=&assetPrefix=&nextConfigOutput=standalone&nextConfigExperimentalUseEarlyImport=&preferredRegion=&middlewareConfig=e30%3D!
...
const routeModule = new module_compiled.AppRouteRouteModule({
    definition: {
        ...
        page: "/api/v1/client/[environmentId]/user/route",
        pathname: "/api/v1/client/[environmentId]/user",
        filename: "route",
        bundlePath: "app/api/v1/client/[environmentId]/user/route"
    },
    resolvedPagePath: "/Users/kdy1/projects/formbricks/apps/web/app/api/v1/client/[environmentId]/user/route.ts",
    nextConfigOutput,
    userland: user_route_namespaceObject
});
...
var __webpack_exports__ = __webpack_require__.X(0, [8079,3073,7863,5069,6626,5570,1238,9069,7762,9358,3687,5863,6483,836,5617], () => (__webpack_exec__(473803)));
