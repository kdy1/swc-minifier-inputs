...
// NAMESPACE OBJECT: ./app/api/v1/client/[environmentId]/storage/local/route.ts
...
var storage_service = __webpack_require__(888843);
// EXTERNAL MODULE: ../../packages/lib/survey/service.ts
var survey_service = __webpack_require__(222118);
;// ./app/api/v1/client/[environmentId]/storage/local/route.ts
...
const POST = async (req, context)=>{
    ...
    const encodedFileName = formData.fileName;
    const surveyId = formData.surveyId;
    const signedSignature = formData.signature;
    const signedUuid = formData.uuid;
    const signedTimestamp = formData.timestamp;
    if (!fileType) {
        return response/* responses */.n.badRequestResponse("contentType is required");
    }
    if (!encodedFileName) {
        return response/* responses */.n.badRequestResponse("fileName is required");
    }
    if (!surveyId) {
        return response/* responses */.n.badRequestResponse("surveyId is required");
    }
    if (!signedSignature) {
    ...
    const [survey, organization] = await Promise.all([
        ...
        (0,service/* getOrganizationByEnvironmentId */.TK)(environmentId)
    ]);
    if (!survey) {
        return response/* responses */.n.notFoundResponse("Survey", surveyId);
    }
    if (!organization) {
        return response/* responses */.n.notFoundResponse("OrganizationByEnvironmentId", environmentId);
    }
    const fileName = decodeURIComponent(encodedFileName);
    // validate signature
    const validated = (0,lib_crypto/* validateLocalSignedUrl */.jQ)(signedUuid, fileName, environmentId, fileType, Number(signedTimestamp), signedSignature, constants/* ENCRYPTION_KEY */.o7);
    if (!validated) {
        return response/* responses */.n.unauthorizedResponse();
    }
    const base64String = formData.fileBase64String;
    ...
    if (!file) {
        return response/* responses */.n.badRequestResponse("fileBuffer is required");
    }
    try {
        const isBiggerFileUploadAllowed = await (0,utils/* getBiggerUploadFileSizePermission */.AM)(organization);
        const bytes = await file.arrayBuffer();
        const fileBuffer = Buffer.from(bytes);
        await (0,storage_service/* putFileToLocalStorage */.BY)(fileName, fileBuffer, accessType, environmentId, constants/* UPLOADS_DIR */.xG, isBiggerFileUploadAllowed);
        ...
        if (err.name === "FileTooLargeError") {
            return response/* responses */.n.badRequestResponse(err.message);
        }
        return response/* responses */.n.internalServerErrorResponse("File upload failed");
    }
};

;// ../../node_modules/next/dist/build/webpack/loaders/next-app-loader/index.js?page=%2Fapi%2Fv1%2Fclient%2F%5BenvironmentId%5D%2Fstorage%2Flocal%2Froute&name=app%2Fapi%2Fv1%2Fclient%2F%5BenvironmentId%5D%2Fstorage%2Flocal%2Froute&pagePath=private-next-app-dir%2Fapi%2Fv1%2Fclient%2F%5BenvironmentId%5D%2Fstorage%2Flocal%2Froute.ts&appDir=%2FUsers%2Fkdy1%2Fprojects%2Fformbricks%2Fapps%2Fweb%2Fapp&appPaths=%2Fapi%2Fv1%2Fclient%2F%5BenvironmentId%5D%2Fstorage%2Flocal%2Froute&pageExtensions=tsx&pageExtensions=ts&pageExtensions=jsx&pageExtensions=js&basePath=&assetPrefix=&nextConfigOutput=standalone&nextConfigExperimentalUseEarlyImport=&preferredRegion=&middlewareConfig=e30%3D!
...
const routeModule = new module_compiled.AppRouteRouteModule({
    definition: {
        ...
        page: "/api/v1/client/[environmentId]/storage/local/route",
        pathname: "/api/v1/client/[environmentId]/storage/local",
        filename: "route",
        bundlePath: "app/api/v1/client/[environmentId]/storage/local/route"
    },
    resolvedPagePath: "/Users/kdy1/projects/formbricks/apps/web/app/api/v1/client/[environmentId]/storage/local/route.ts",
    nextConfigOutput,
...
var __webpack_exports__ = __webpack_require__.X(0, [8079,3073,7863,5069,6626,5570,1238,9069,7762,8728,9398,881,9358,3687,5863,7043], () => (__webpack_exec__(248359)));
