...
// NAMESPACE OBJECT: ./app/api/google-sheet/callback/route.ts
...
var src = __webpack_require__(380928);
...
;// ./app/api/google-sheet/callback/route.ts
...
const GET = async (req)=>{
    ...
    if (!client_id) return response/* responses */.n.internalServerErrorResponse("Google client id is missing");
    if (!client_secret) return response/* responses */.n.internalServerErrorResponse("Google client secret is missing");
    if (!redirect_uri) return response/* responses */.n.internalServerErrorResponse("Google redirect url is missing");
    const oAuth2Client = new src.google.auth.OAuth2(client_id, client_secret, redirect_uri);
    let key;
    let userEmail;
    if (code) {
        ...
        // Fetch user's email
        const oauth2 = src.google.oauth2({
            auth: oAuth2Client,
            version: "v2"
        });
    ...
    const result = await (0,service/* createOrUpdateIntegration */.d6)(environmentId, googleSheetIntegration);
    if (result) {
        return Response.redirect(`${constants/* WEBAPP_URL */.YW}/environments/${environmentId}/integrations/google-sheets`);
    }
};

;// ../../node_modules/next/dist/build/webpack/loaders/next-app-loader/index.js?page=%2Fapi%2Fgoogle-sheet%2Fcallback%2Froute&name=app%2Fapi%2Fgoogle-sheet%2Fcallback%2Froute&pagePath=private-next-app-dir%2Fapi%2Fgoogle-sheet%2Fcallback%2Froute.ts&appDir=%2FUsers%2Fkdy1%2Fprojects%2Fformbricks%2Fapps%2Fweb%2Fapp&appPaths=%2Fapi%2Fgoogle-sheet%2Fcallback%2Froute&pageExtensions=tsx&pageExtensions=ts&pageExtensions=jsx&pageExtensions=js&basePath=&assetPrefix=&nextConfigOutput=standalone&nextConfigExperimentalUseEarlyImport=&preferredRegion=&middlewareConfig=e30%3D!
...
const routeModule = new module_compiled.AppRouteRouteModule({
    definition: {
        ...
        page: "/api/google-sheet/callback/route",
        pathname: "/api/google-sheet/callback",
        filename: "route",
        bundlePath: "app/api/google-sheet/callback/route"
    },
    resolvedPagePath: "/Users/kdy1/projects/formbricks/apps/web/app/api/google-sheet/callback/route.ts",
    nextConfigOutput,
...
var __webpack_exports__ = __webpack_require__.X(0, [8079,3073,7863,5069,5570,9069,4150,928], () => (__webpack_exec__(389399)));
