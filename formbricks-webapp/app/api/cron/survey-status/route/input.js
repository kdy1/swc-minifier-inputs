...
// NAMESPACE OBJECT: ./app/api/cron/survey-status/route.ts
...
var cache = __webpack_require__(249479);
;// ./app/api/cron/survey-status/route.ts
...
const POST = async ()=>{
    ...
    if (!apiKey || apiKey !== constants/* CRON_SECRET */.Kd) {
    ...
    const surveysToClose = await src/* prisma */.z.survey.findMany({
        where: {
            status: "inProgress",
            closeOnDate: {
                lte: new Date()
    ...
    if (surveysToClose.length) {
        await src/* prisma */.z.survey.updateMany({
            where: {
                id: {
    ...
    const scheduledSurveys = await src/* prisma */.z.survey.findMany({
        where: {
            status: "scheduled",
            runOnDate: {
                lte: new Date()
...
;// ../../node_modules/next/dist/build/webpack/loaders/next-app-loader/index.js?page=%2Fapi%2Fcron%2Fsurvey-status%2Froute&name=app%2Fapi%2Fcron%2Fsurvey-status%2Froute&pagePath=private-next-app-dir%2Fapi%2Fcron%2Fsurvey-status%2Froute.ts&appDir=%2FUsers%2Fkdy1%2Fprojects%2Fformbricks%2Fapps%2Fweb%2Fapp&appPaths=%2Fapi%2Fcron%2Fsurvey-status%2Froute&pageExtensions=tsx&pageExtensions=ts&pageExtensions=jsx&pageExtensions=js&basePath=&assetPrefix=&nextConfigOutput=standalone&nextConfigExperimentalUseEarlyImport=&preferredRegion=&middlewareConfig=e30%3D!
...
const routeModule = new module_compiled.AppRouteRouteModule({
    definition: {
        ...
        page: "/api/cron/survey-status/route",
        pathname: "/api/cron/survey-status",
        filename: "route",
        bundlePath: "app/api/cron/survey-status/route"
    },
    resolvedPagePath: "/Users/kdy1/projects/formbricks/apps/web/app/api/cron/survey-status/route.ts",
    nextConfigOutput,
...
var __webpack_exports__ = __webpack_require__.X(0, [8079,3073,7863,255], () => (__webpack_exec__(264623)));
