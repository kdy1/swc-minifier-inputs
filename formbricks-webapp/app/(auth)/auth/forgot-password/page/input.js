...
const module8 = () => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 381733));
const page9 = () => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 810538));
...
const tree = {
        ...
        {
        children: ['__PAGE__', {}, {
          page: [page9, "/Users/kdy1/projects/formbricks/apps/web/app/(auth)/auth/forgot-password/page.tsx"],
        ...
        {
        'layout': [module8, "/Users/kdy1/projects/formbricks/apps/web/app/(auth)/auth/layout.tsx"],
...
const pages = ["/Users/kdy1/projects/formbricks/apps/web/app/(auth)/auth/forgot-password/page.tsx"];
...
__webpack_require__.d(__webpack_exports__, {
  ...
  "7fdd1f332ac2090201b01252ebf2c995bef17fb9ef": () => (/* reexport */ forgotPasswordAction),
...
;// ./modules/auth/forgot-password/actions.ts
/* __next_internal_action_entry_do_not_use__ {"7fdd1f332ac2090201b01252ebf2c995bef17fb9ef":"forgotPasswordAction"} */ 





const ZForgotPasswordAction = lib.z.object({
    email: lib.z.string().max(255).email({
        message: "Invalid email"
    })
});
const /*#__TURBOPACK_DISABLE_EXPORT_MERGING__*/ forgotPasswordAction = action_client/* actionClient */._.schema(ZForgotPasswordAction).action(async ({ parsedInput })=>{
    const user = await (0,lib_user/* getUserByEmail */.ht)(parsedInput.email);
    if (user) {
        await (0,email/* sendForgotPasswordEmail */.bE)(user);
    }
    return {
        success: true
    };
...
Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 824341));
...
Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 578510));
...
// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  ForgotPasswordForm: () => (/* binding */ ForgotPasswordForm)
});
...
;// ../../node_modules/next/dist/build/webpack/loaders/next-flight-server-reference-proxy-loader.js?id=7fdd1f332ac2090201b01252ebf2c995bef17fb9ef&name=forgotPasswordAction!

const forgotPasswordAction = /*#__PURE__*/(0,action_client_wrapper.createServerReference)("7fdd1f332ac2090201b01252ebf2c995bef17fb9ef", action_client_wrapper.callServer, undefined, action_client_wrapper.findSourceMapURL, "forgotPasswordAction")
...
;// ./modules/auth/forgot-password/components/forgot-password-form.tsx
/* __next_internal_client_entry_do_not_use__ ForgotPasswordForm auto */ 
...
const ZForgotPasswordForm = lib.z.object({
...
const ForgotPasswordForm = ()=>{
    ...
    const form = (0,index_esm/* useForm */.mN)({
        ...
        resolver: (0,zod/* zodResolver */.u)(ZForgotPasswordForm)
    });
    const handleSubmit = async (data)=>{
        const forgotPasswordResponse = await forgotPasswordAction({
            email: data.email
        });
        if (forgotPasswordResponse?.data) {
            router.push("/auth/forgot-password/email-sent");
        } else {
            const errorMessage = (0,helper/* getFormattedErrorMessage */.g3)(forgotPasswordResponse);
                ...
                /*#__PURE__*/ (0,react_jsx_runtime.jsxs)("div", {
                    children: [
                        /*#__PURE__*/ (0,react_jsx_runtime.jsx)(components_button/* Button */.$, {
                            ...
                            children: t("auth.forgot-password.reset_password")
                        }),
                        /*#__PURE__*/ (0,react_jsx_runtime.jsx)("div", {
                            ...
                            children: /*#__PURE__*/ (0,react_jsx_runtime.jsx)(components_button/* Button */.$, {
                                ...
                                children: /*#__PURE__*/ (0,react_jsx_runtime.jsx)((link_default()), {
                                    href: "/auth/login",
                                    children: t("auth.forgot-password.back_to_login")
                                })
                            })
                        })
                    ]
...
// EXTERNAL MODULE: ./modules/auth/components/form-wrapper.tsx + 1 modules
var form_wrapper = __webpack_require__(487506);
// EXTERNAL MODULE: ./modules/auth/forgot-password/components/forgot-password-form.tsx
var forgot_password_form = __webpack_require__(824341);
;// ./modules/auth/forgot-password/page.tsx



const ForgotPasswordPage = ()=>{
    return /*#__PURE__*/ (0,react_jsx_runtime.jsx)(form_wrapper/* FormWrapper */._, {
        children: /*#__PURE__*/ (0,react_jsx_runtime.jsx)(forgot_password_form.ForgotPasswordForm, {})
    });
};

;// ./app/(auth)/auth/forgot-password/page.tsx

/* harmony default export */ const page = (ForgotPasswordPage);
...
const ForgotPasswordForm = (0,react_server_dom_webpack_server_edge__WEBPACK_IMPORTED_MODULE_0__.registerClientReference)(
...
"/Users/kdy1/projects/formbricks/apps/web/modules/auth/forgot-password/components/forgot-password-form.tsx",
"ForgotPasswordForm",
);
...
var __webpack_exports__ = __webpack_require__.X(0, [8079,3073,7863,5069,255,9759,6626,5570,1238,2021,9069,2195,7762,1469,5294,4900,2415,3687,7864,8046,8015,4256], () => (__webpack_exec__(110139)));
