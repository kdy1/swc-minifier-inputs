...
const page9 = () => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 717121));
...
const tree = {
        ...
        {
        children: [
        'signup-without-verification-success',
        {
        children: ['__PAGE__', {}, {
          page: [page9, "/Users/kdy1/projects/formbricks/apps/web/app/(auth)/auth/signup-without-verification-success/page.tsx"],
...
const pages = ["/Users/kdy1/projects/formbricks/apps/web/app/(auth)/auth/signup-without-verification-success/page.tsx"];
...
const routeModule = new next_dist_server_route_modules_app_page_module_compiled__WEBPACK_IMPORTED_MODULE_0__.AppPageRouteModule({
    definition: {
        ...
        page: "/(auth)/auth/signup-without-verification-success/page",
        pathname: "/auth/signup-without-verification-success",
...
// EXTERNAL MODULE: ./modules/auth/components/back-to-login-button.tsx
var back_to_login_button = __webpack_require__(593559);
...
;// ./modules/auth/signup-without-verification-success/page.tsx




const SignupWithoutVerificationSuccessPage = async ()=>{
    const t = await (0,server/* getTranslate */.r)();
    return /*#__PURE__*/ (0,react_jsx_runtime.jsxs)(form_wrapper/* FormWrapper */._, {
        children: [
            /*#__PURE__*/ (0,react_jsx_runtime.jsx)("h1", {
                className: "leading-2 mb-4 text-center font-bold",
                children: t("auth.signup_without_verification_success.user_successfully_created")
            }),
            /*#__PURE__*/ (0,react_jsx_runtime.jsx)("p", {
                className: "text-center text-sm",
                children: t("auth.signup_without_verification_success.user_successfully_created_description")
            }),
            /*#__PURE__*/ (0,react_jsx_runtime.jsx)("hr", {
                className: "my-4"
            }),
            /*#__PURE__*/ (0,react_jsx_runtime.jsx)(back_to_login_button/* BackToLoginButton */.o, {})
        ]
    });
};

;// ./app/(auth)/auth/signup-without-verification-success/page.tsx

/* harmony default export */ const page = (SignupWithoutVerificationSuccessPage);
...
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   o: () => (/* binding */ BackToLoginButton)
/* harmony export */ });
...
const BackToLoginButton = async ()=>{
    ...
    return /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_modules_ui_components_button__WEBPACK_IMPORTED_MODULE_1__/* .Button */ .$, {
        variant: "secondary",
...
var __webpack_exports__ = __webpack_require__.X(0, [8079,3073,7863,5069,255,9759,6626,5570,1238,2021,9069,2195,7762,5268,3687,7864,4256], () => (__webpack_exec__(22039)));
